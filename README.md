...
| 2 |  [interviews](https://github.com/kdn251/interviews) | Everything you need to know to get the job. | kdn251 | 49497 |
...
| 2 |  [workbox](https://github.com/GoogleChrome/workbox) | 📦 Workbox: JavaScript libraries for Progressive Web Apps | GoogleChrome | 9727 |
...
| 5 |  [leerob.io](https://github.com/leerob/leerob.io) | ✨  My portfolio built with Next.js, MDX, Tailwind CSS, and Vercel. | leerob | 886 |
| 6 |  [pollyjs](https://github.com/Netflix/pollyjs) | Record, Replay, and Stub HTTP Interactions. | Netflix | 8793 |
...
| 8 |  [ffmpeg.wasm](https://github.com/ffmpegwasm/ffmpeg.wasm) | FFmpeg for browser and node, powered by WebAssembly | ffmpegwasm | 3175 |
| 9 |  [webpack-bundle-analyzer](https://github.com/webpack-contrib/webpack-bundle-analyzer) | Webpack plugin and CLI utility that represents bundle content as convenient interactive zoomable treemap | webpack-contrib | 10583 |
| 10 |  [whatsapp-web.js](https://github.com/pedroslopez/whatsapp-web.js) | A WhatsApp client library for NodeJS that connects through the WhatsApp Web browser app | pedroslopez | 1437 |
| 11 |  [screenity](https://github.com/alyssaxuu/screenity) | The most powerful screen recorder &amp; annotation tool for Chrome 🎥 | alyssaxuu | 4724 |
...
| 15 |  [quill](https://github.com/quilljs/quill) | Quill is a modern WYSIWYG editor built for compatibility and extensibility. | quilljs | 28582 |
...
| 17 |  [Vue.Draggable](https://github.com/SortableJS/Vue.Draggable) | Vue drag-and-drop component based on Sortable.js | SortableJS | 14000 |
...
| 22 |  [github-profile-readme-generator](https://github.com/arturssmirnovs/github-profile-readme-generator) | GitHub profile readme generator allows you to create nice and simple GitHub profile readme files that will be included in your profile previews. | arturssmirnovs | 309 |
| 23 |  [waypoints](https://github.com/imakewebthings/waypoints) | Waypoints is a library that makes it easy to execute a function whenever you scroll to an element. | imakewebthings | 10184 |
...
| 25 |  [yarn](https://github.com/yarnpkg/yarn) | The 1.x line is frozen - features and bugfixes now happen on https://github.com/yarnpkg/berry | yarnpkg | 39408 |
| 26 |  [googleDictionaryAPI](https://github.com/meetDeveloper/googleDictionaryAPI) | Google does not provide Google Dictionary API so I created one. | meetDeveloper | 453 |
...
| 65 |  [popcorn-desktop](https://github.com/popcorn-official/popcorn-desktop) | Popcorn Time is a multi-platform, free software BitTorrent client that includes an integrated media player ( Windows / Mac / Linux ) A Butter-Project Fork | popcorn-official | 5425 |
...
| 98 |  [leetcode](https://github.com/azl397985856/leetcode) | LeetCode Solutions: A Record of My Problem Solving Journey.( leetcode题解，记录自己的leetcode解题之路。) | azl397985856 | 39073 |
...
| 135 |  [json-server](https://github.com/typicode/json-server) | Get a full fake REST API with zero coding in less than 30 seconds (seriously) | typicode | 51370 |
...
|  | Name 	|  Description 	| Author  	|  Stars 	|
|---	|---	|---	|---	|---	|
| 1 |  [crater](https://github.com/bytefury/crater) | Free &amp; Open Source Invoice App for Freelancers &amp; Small Businesses | bytefury | 3581 |
...
| 4 |  [alfred-spotify-mini-player](https://github.com/vdesabou/alfred-spotify-mini-player) | 🎵🎩 Alfred workflow to control your Spotify library at your fingertips | vdesabou | 790 |
...
|  | Name 	|  Description 	| Author  	|  Stars 	|
|---	|---	|---	|---	|---	|
| 1 |  [Depix](https://github.com/beurtschipper/Depix) | Recovers passwords from pixelized screenshots | beurtschipper | 14215 |
...
| 5 |  [notion-search-alfred-workflow](https://github.com/wrjlewis/notion-search-alfred-workflow) | An Alfred workflow to search Notion with instant results | wrjlewis | 242 |
...
| 11 |  [posthog](https://github.com/PostHog/posthog) | 🦔 PostHog is developer-friendly, open-source product analytics. | PostHog | 3571 |
...
| 14 |  [devicon](https://github.com/devicons/devicon) | Set of icons representing programming languages, designing &amp; development tools | devicons | 3047 |
...
| 18 |  [system-design-primer](https://github.com/donnemartin/system-design-primer) | Learn how to design large-scale systems. Prep for the system design interview.  Includes Anki flashcards. | donnemartin | 117436 |
| 19 |  [public-apis](https://github.com/public-apis/public-apis) | A collective list of free APIs for use in software and web development. | public-apis | 107005 |
| 20 |  [recursive](https://github.com/arrowtype/recursive) | Recursive Mono &amp; Sans is a variable font family for code &amp; UI, coming soon to Google Fonts | arrowtype | 1624 |
...
| 24 |  [transformers](https://github.com/huggingface/transformers) | 🤗Transformers: State-of-the-art Natural Language Processing for Pytorch and TensorFlow 2.0. | huggingface | 38950 |
| 25 |  [DeepFaceLab](https://github.com/iperov/DeepFaceLab) | DeepFaceLab is the leading software for creating deepfakes. | iperov | 22673 |
...
|  | Name 	|  Description 	| Author  	|  Stars 	|
|---	|---	|---	|---	|---	|
| 1 |  [Pock](https://github.com/pigigaldi/Pock) | Display macOS Dock in Touch Bar | pigigaldi | 8517 |
| 2 |  [Rectangle](https://github.com/rxhanson/Rectangle) | Move and resize windows on macOS with keyboard shortcuts and snap areas | rxhanson | 7369 |
| 3 |  [Gifski](https://github.com/sindresorhus/Gifski) | 🌈 Convert videos to high-quality GIFs on your Mac | sindresorhus | 5014 |
...
|  | Name 	|  Description 	| Author  	|  Stars 	|
|---	|---	|---	|---	|---	|
| 1 |  [react-components-by-ruvkr](https://github.com/ruvkr/react-components-by-ruvkr) | A collection of Responsive Animated Mobile friendly Lightweight React Components | ruvkr | 274 |
| 2 |  [snapchat-clone](https://github.com/TowhidKashem/snapchat-clone) | 👻 A SnapChat clone built with React, Redux and Typescript. Styled with SASS. Tested with Cypress, Jest and Enzyme. Linted with Eslint and formatted with Prettier! | TowhidKashem | 733 |
| 3 |  [imove](https://github.com/imgcook/imove) | Move your mouse, generate code from flow chart | imgcook | 74 |
| 4 |  [refined-github](https://github.com/sindresorhus/refined-github) | :octocat: Browser extension that simplifies the GitHub interface and adds useful features | sindresorhus | 13419 |
| 5 |  [caprine](https://github.com/sindresorhus/caprine) | Elegant Facebook Messenger desktop app | sindresorhus | 5714 |
...
| 7 |  [react-icons](https://github.com/react-icons/react-icons) | svg react icons of popular icon packs | react-icons | 5610 |
| 8 |  [grammarly](https://github.com/znck/grammarly) | Unofficial Grammarly VS Code Extension | znck | 511 |
| 9 |  [CrewLink](https://github.com/ottomated/CrewLink) | Free, open, Among Us Proximity Chat | ottomated | 2302 |
| 10 |  [mikro-orm](https://github.com/mikro-orm/mikro-orm) | TypeScript ORM for Node.js based on Data Mapper, Unit of Work and Identity Map patterns. Supports MongoDB, MySQL, MariaDB, PostgreSQL and SQLite databases. | mikro-orm | 2360 |
...
| 12 |  [vscode-stories](https://github.com/ide-stories/vscode-stories) | Stories for VSCode | ide-stories | 1907 |
| 13 |  [vite-plugin-pwa](https://github.com/antfu/vite-plugin-pwa) | Zero-config PWA for Vite | antfu | 123 |
| 14 |  [lit-html](https://github.com/Polymer/lit-html) | An efficient, expressive, extensible HTML templating library for JavaScript. | Polymer | 6922 |
| 15 |  [composition-api](https://github.com/vuejs/composition-api) | Composition API plugin for Vue 2 | vuejs | 2878 |
...
| 17 |  [vetur](https://github.com/vuejs/vetur) | Vue tooling for VS Code. | vuejs | 4857 |
| 18 |  [nsfw-filter](https://github.com/nsfw-filter/nsfw-filter) | 🚀 A Google Chrome / Firefox extension that blocks NSFW images from the web pages that you load using TensorFlow JS. | nsfw-filter | 928 |
| 19 |  [vitesse](https://github.com/antfu/vitesse) | 🏕 Opinionated Vite Starter Template | antfu | 353 |
| 20 |  [pnpm](https://github.com/pnpm/pnpm) | 📦🚀 Fast, disk space efficient package manager | pnpm | 9422 |
| 21 |  [Gitako](https://github.com/EnixCoda/Gitako) | 🐙 File tree extension for GitHub on Chrome &amp; Firefox &amp; Edge | EnixCoda | 903 |
| 22 |  [graphiql](https://github.com/graphql/graphiql) | GraphiQL &amp; the GraphQL LSP Reference Ecosystem for building browser &amp; IDE tools. | graphql | 11571 |
